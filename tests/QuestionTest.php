...
class QuestionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\interview\Question',
            new \interview\Question(1, new \interview\Database));
    }
    ...
    {
        $this->assertNotEmpty(\interview\Question::getNameById(1,
    ...
    {
        $this->assertNotEmpty(\interview\Question::getTextById(1,
            new \interview\Database));
    }
    ...
    {
        $this->assertNotEmpty(\interview\Question::getAnswerById(1,
            new \interview\Database));
    }
    ...
    {
        $this->assertNotEmpty(\interview\Question::getCreatedById(1,
            new \interview\Database));
    }
    ...
    public function testQuestionsAnswered()
    {
        $this->assertNotEmpty(\interview\Question::getAnswerById(1,
            new \interview\Database));
        $this->assertNotEmpty(\interview\Question::getAnswerById(2,
            new \interview\Database));
        $this->assertNotEmpty(\interview\Question::getAnswerById(3,
            new \interview\Database));
    }
    //--------------------------------------------------------------------------
}
